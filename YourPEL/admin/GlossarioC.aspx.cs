...
{
    public partial class GlossarioC : System.Web.UI.Page
    {
        ...
        protected void btnAddEntradaGlossario_Click(object sender, EventArgs e)
        {
                ...
                && txtDescricaoEntradaGlossario.Text != "")
            {
                ...
                XDocument doc = XDocument.Load(Server.MapPath("glossarioC.xml"));
                ...
                {//primeira letra coincide com uma do glossário
                    ...
                    doc.Save(Server.MapPath("glossarioC.xml"));
        ...
        protected void gv_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            xd.Load(Server.MapPath("glossarioC.xml"));
            ...
            xd.Save(Server.MapPath("glossarioC.xml"));
            this.DataBind(); //refresh dos XML sources
