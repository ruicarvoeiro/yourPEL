<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Administracao.Master" AutoEventWireup="true" CodeBehind="GlossarioA.aspx.cs" Inherits="AdminYourPEL.GlossarioA" %>
...
<asp:Content ID="Content20" ContentPlaceHolderID="GestaoGlossario" runat="server">
    ...
    <ul class="nav nav-pills">
        <!-- class="active" -->
        <li role="presentation" class="active"><a href="GlossarioA.aspx">Alimentação</a></li>
...
<asp:Content ID="GlossarioAlimentacao" ContentPlaceHolderID="GlossarioA" runat="server">
    <form runat="server">
        <div class="container">
            ...
            <div runat="server" id="listaGlossario" class="row">
                ...
                <asp:XmlDataSource ID="XmlDataSourceA" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='a']/definicao" EnableCaching="false"></asp:XmlDataSource>
                <br />
                <h3 id="letraB">B</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceB" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='b']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraC">C</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceC" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='c']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraD">D</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceD" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='d']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraE">E</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceE" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='e']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraF">F</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceF" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='f']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraG">G</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceG" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='g']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraH">H</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceH" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='h']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraI">I</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceI" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='i']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraJ">J</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceJ" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='j']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraK">K</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceK" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='k']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraL">L</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceL" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='l']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraM">M</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceM" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='m']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraN">N</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceN" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='n']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraO">O</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceO" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='o']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraP">P</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceP" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='p']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraQ">Q</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceQ" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='q']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraR">R</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceR" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='r']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraS">S</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceS" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='s']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraT">T</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceT" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='t']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraU">U</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceU" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='u']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraV">V</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceV" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='v']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraW">W</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceW" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='w']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraX">X</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceX" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='x']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraY">Y</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceY" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='y']/definicao"></asp:XmlDataSource>
                <br />
                <h3 id="letraZ">Z</h3>
                ...
                <asp:XmlDataSource ID="XmlDataSourceZ" runat="server" DataFile="~/glossarioA.xml" TransformFile="~/XSLFile1.xsl" XPath="//letra[@id='z']/definicao"></asp:XmlDataSource>
